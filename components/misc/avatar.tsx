...
function Avatar({ full_name, avatar_url, width, height, text_size = 'sm' }: AvatarProps) {
  ...
  return (
    <div className="flex items-center">
      {avatar_url ? (
        ...
        >
          <div className={`flex h-${height} w-${width} items-center text-white justify-center text-${text_size} rounded-full`}>
            {initials}
          </div>
        </div>
      )}
