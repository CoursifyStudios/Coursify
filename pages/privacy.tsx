	...
	return (
		<div className="prose mt-10 mx-auto prose-lg dark:text-white">
			...
			<ul>
				<li>
					<p>
						Visit our website at app.coursify.one, or any website of ours that
			...
			<p>
				You may contact us by email at privacy@coursify.studio, or by referring
			...
			<p>
				...
				privacy@coursify.studio, or by referring to the contact details at the
