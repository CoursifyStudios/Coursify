	...
	return (
		<>
			...
			<div className="z-50 space-y-3">
				...
				<button className="flex z-50 rounded-3xl md:px-14 xl:px-20 [@media(min-width:2000px)]:px-28 text-lg md:py-7 px-5 py-4 items-center justify-center cursor-not-allowed bg-gray-200 text-[1.05rem] font-medium grayscale">
					<Image
